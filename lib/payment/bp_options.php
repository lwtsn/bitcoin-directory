...
$bpOptions['notificationEmail'] = $contact_email;
...
$bpOptions['notificationURL'] = $siteroot.'callback.php';
...
$bpOptions['redirectURL'] = $siteroot.'confirmation.php';
